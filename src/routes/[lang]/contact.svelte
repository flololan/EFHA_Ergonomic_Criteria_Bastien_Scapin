...
<main id="mainContent" class="container">
  ...
  >
    <div class="d-flex justify-content-end">
      <p class="d-inline alert alert-warning w-fit-content p-2">
        {$_('contact_page.required_field')}
      </p>
    </div>
    <div class="row">
      <div class="col">
        <div class="form-floating mb-3" aria-live="polite">
          ...
          {#if isSubmitted && errors.firstName}
            <p id="invalidFirstname" class="text-danger">
              {$_('contact_page.invalid_info.firstname', {
      ...
      <div class="col">
        <div class="form-floating mb-3" aria-live="polite">
          ...
          {#if isSubmitted && errors.lastName}
            <p id="invalidLastname" class="text-danger">
              {$_('contact_page.invalid_info.lastname', {
                values: { length: MIN_NAME_LENGTH },
              })}
            </p>
          {/if}
    ...
    <div class="form-floating mb-3" aria-live="polite">
      ...
      {#if isSubmitted && errors.email}
        <p id="invalidEmail" class="text-danger">
          {$_('contact_page.invalid_info.email')}
        </p>
      {/if}
    </div>
    ...
    <div class="form-floating mb-3">
      ...
      {#if errors.message}
        <p
          ...
          aria-atomic="true"
        >
          {$_('contact_page.invalid_info.message_min_length', {
            values: { length: MIN_MESSAGE_LENGTH },
          })}
          ({$_('contact_page.currently').toLocaleLowerCase()}
